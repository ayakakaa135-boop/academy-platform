    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(blank=True, verbose_name='نبذة عني')),
                ...
                ('enrolled_courses', models.ManyToManyField(related_name='enrolled_users', through='courses.Enrollment', to='courses.course', verbose_name='الدورات المسجلة')),
